...
\item Chapter 5 talks about another emergent property: giant number fluctuation. Portions of this chapter have been published in \cite{Liu2020}.
...
\begin{figure}[!htbp]
	...
	(a) 10 $\mu$m diameter PS particles suspended in a bath of \text{E. coli}
...
\begin{figure}[!htbp]
	\begin{center}
	\includegraphics[width=4.5 in]{Figs/1-Intro/4.pdf}
	%select pdftexify command to run jpg or pdf files
	\end{center}
